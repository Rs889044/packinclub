    ...
    <div className="max-w-3xl">
      <div className="mb-8 p-6 bg-gradient-to-r from-brand-forest to-[#1A4533] rounded-2xl text-white shadow-lg overflow-hidden relative">
         ...
         <div className="relative z-10">
           <h1 className="font-display text-2xl md:text-3xl font-bold mb-2">Contact & Global Data</h1>
           <p className="text-white/80 text-sm">Manage the official address, emails, and phone numbers shown globally.</p>
         </div>
      </div>

      <form onSubmit={handleSave} className="bg-white rounded-2xl border border-brand-pale p-8 space-y-6">
        <div>
          <label className="block text-sm font-semibold text-brand-charcoal mb-2">Office Address</label>
          <textarea
            rows={3}
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-semibold text-brand-charcoal mb-2">Support Email</label>
            <input
              type="text"
