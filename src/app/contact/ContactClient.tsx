          ...
          <div className="grid sm:grid-cols-3 gap-6">
            <FadeIn>
              <div className="bg-brand-cream rounded-2xl p-6 text-center hover:shadow-lg transition-shadow h-full flex flex-col justify-center">
                ...
                <a href={`tel:${contact.phone.replace(/\s+/g, '')}`} className="text-brand-forest font-medium hover:underline">
                  {contact.phone}
                </a>
              </div>
            </FadeIn>
            <FadeIn delay={0.1}>
              <div className="bg-brand-cream rounded-2xl p-6 text-center hover:shadow-lg transition-shadow h-full flex flex-col justify-center">
                ...
                <a href={`mailto:${contact.email}`} className="text-brand-forest font-medium hover:underline break-all">
                  {contact.email}
                </a>
              </div>
            </FadeIn>
            <FadeIn delay={0.2}>
              <div className="bg-brand-cream rounded-2xl p-6 text-center hover:shadow-lg transition-shadow h-full flex flex-col justify-center">
                ...
                <p className="text-sm text-brand-gray whitespace-pre-line">{contact.address}</p>
              </div>
            </FadeIn>
          </div>
        </div>
                ...
                <div className="bg-brand-cream rounded-3xl p-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-3">
                      ...
                      <p className="text-sm text-brand-charcoal font-medium whitespace-pre-line">{contact.address}</p>
                    </div>
                    <div className="flex gap-3 items-center">
                      ...
                      <a href={`tel:${contact.phone.replace(/\s+/g, '')}`} className="text-sm text-brand-charcoal font-medium hover:text-brand-forest transition-colors">{contact.phone}</a>
                    </div>
                    <div className="flex gap-3 items-center">
                      ...
                      <a href={`mailto:${contact.email}`} className="text-sm text-brand-charcoal font-medium hover:text-brand-forest transition-colors break-all">{contact.email}</a>
                    </div>
                  </div>
                </div>
              </div>
